...
MODEL_PATHS={"HMEQ":PROJECT_ROOT/"src/models/HMEQ_model.keras","AUSTRALIAN":PROJECT_ROOT/"src/models/AUSTRALIAN_model.keras"}
...
if st.button("Predict Credit Risk"):
    ...
    df["TARGET"]=0
    images,_,B,D,features=convert_to_images(df,target="TARGET",bin_info=bin_info,selected_features=selected_features)
    sample=images[0]
